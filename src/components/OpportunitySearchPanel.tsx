    ...
    <div className="flex-1 bg-[#161a1e] border border-[#2b2f36] rounded-lg p-3 flex flex-col gap-2.5 min-h-[220px] overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto space-y-2.5 pr-0.5">
        ...
        {filteredOpportunities.map((opp, i) => {
          const isBullish = ['explosion', 'bottom_fishing', 'ema_golden_cross', 'breakout', 'vol_rejection', 'rsi_jump_4h', 'rsi_cross_1h_4h'].includes(opp.type);
          ...
          >
            <div className="flex flex-col flex-1 min-w-0 pr-1">
              ...
              <div className="grid grid-cols-2 gap-1.5 w-full">
                ...
                {(opp.type === "ema_golden_cross" || opp.type === "breakout" || opp.type === "vol_rejection" || opp.type === "rsi_jump_4h" || opp.type === "rsi_cross_1h_4h") && (
